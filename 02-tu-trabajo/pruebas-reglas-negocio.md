...
| RN2-B sexto prestamo posgrado  | RN2   | 409             | 201           | loan created (no borrower limit) |
| RN5-B ejemplar ya prestado     | RN5   | 409             | 400           | {"error":"No hay copias disponibles"} |
| RN6-A plazo libro normal       | RN6   | fecha + 15 dias | 201           | loan created (no fechaDevolucion/plazo) |
| RN6-B plazo alta demanda       | RN6   | fecha + 3 dias  | 201           | loan created (no fechaDevolucion/plazo) |
| RN3 prestamo con vencido       | RN3   | 409             | 201           | loan created (no overdue check) |
| RN4-B prestamo con multa       | RN4   | 409             | 201           | loan created (no fine check) |
| RN8 calculo de multa           | RN8   | N x 2000        | 200           | returned loan object, no multa field |
| VAL-1 body vacio               | —     | 400             | 400           | {"error":"Falta bookId o borrower"} |
| VAL-2 estudiante inexistente   | —     | 404             | 201           | loan created (no student validation) |
